...
class Block(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride, expand_ratio=1, se_ratio=0., drop_rate=0., track_running_stats=False):
...
class EfficientNet(nn.Module):
    def __init__(self, cfg, num_classes=10, track_running_stats=True, slim_idx=0, scale=4):
...
def EfficientNetB0(num_classes=10, track_running_stats=True, slim_idx=0, scale=4):
    ...
    return EfficientNet(cfg, num_classes=num_classes, track_running_stats=track_running_stats, slim_idx=slim_idx, scale=scale)


def EfficientNetB4(num_classes=10, track_running_stats=True, slim_idx=0, scale=4):
    cfg = {
